...
import com.melofy.app.api.ApiClient
import com.melofy.app.db.AppDatabase
import com.melofy.app.db.CollectionItem
...
data class UiState(
    ...
    val searchResults: List<com.melofy.app.api.SpotifySearchItem> = emptyList(),
